...
do
  ...
  XLA_PYTHON_CLIENT_MEM_FRACTION=.99 CUDA_VISIBLE_DEVICES=0 python train.py -o Hyena_Mamba_zero_full_non_consecutive -c configs/hyena_S5/wikitext_Mamba_v7_non_consecutive.yaml --train_length $length
done

...
# Train the model
touch script_logs/expr7_${length}.txt

XLA_PYTHON_CLIENT_MEM_FRACTION=.99 CUDA_VISIBLE_DEVICES=0 \
/home/aiops/wangsd/miniforge3/envs/S5AIP/bin/python train.py \
-o Mamba_zero_V0 \
-c configs/hyena_S5/wikitext_Mamba_v11_1b.yaml \
--train_length $length | tee -a script_logs/expr7_${length}.txt
...
-c configs/hyena_S5/wikitext_Mamba_v11_1b.yaml \
| tee -a "script_logs/expr7_${length}evaluation.txt"
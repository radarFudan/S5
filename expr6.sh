...
# Train the model
touch script_logs/expr6_${length}.txt

XLA_PYTHON_CLIENT_MEM_FRACTION=.99 CUDA_VISIBLE_DEVICES=0 \
/home/aiops/wangsd/miniforge3/envs/S5AIP/bin/python train.py \
-o Mamba_previous_V0 \
-c configs/hyena_S5/wikitext_Mamba_v10_120m.yaml \
--train_length $length | tee -a script_logs/expr6_${length}.txt
...
-o "Mamba_previous_V0_T${length}" \
-c configs/hyena_S5/wikitext_Mamba_v10_120m.yaml \
| tee -a "script_logs/expr6_${length}evaluation.txt"
